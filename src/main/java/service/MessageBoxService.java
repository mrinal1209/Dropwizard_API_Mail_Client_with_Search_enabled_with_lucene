...
public abstract class MessageBoxService {
    ...
    @CreateSqlObject
    abstract MessageBoxDao msgBoxDao();



    public MessageBox createMessageBox(MessageBox msgBox) {
        return  msgBoxDao().getMessageBox((int) msgBoxDao().createMessageBox(msgBox));
    }

    public List<Integer> getMessageIdFromRecevierId(int id){
        return msgBoxDao().getMessageIdFromRecevierId(id);
    }

    public void hasRead(int id){
        msgBoxDao().hasRead(id);
    }


    public String performHealthCheck() {
        try {
            msgBoxDao().getMessageBoxs();
