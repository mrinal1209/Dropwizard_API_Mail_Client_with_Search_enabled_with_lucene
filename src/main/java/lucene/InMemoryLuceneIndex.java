...
public class InMemoryLuceneIndex {
    ...
    public void indexDocument(String to , String from , String subject, String body) {
        ...
        try {
            ...
            document.add(new TextField("to", to, Field.Store.YES));
            document.add(new TextField("from", from, Field.Store.YES));
            document.add(new TextField("subject", subject, Field.Store.YES));
            document.add(new TextField("body", body, Field.Store.YES));
            document.add(new SortedDocValuesField("subject", new BytesRef(subject)));
